...
아니라 `herding_controller_dual/maps/room_map.pgm`로 이미 SLAM된 실제 방이고,
...
하는 벽 회피 이동 헬퍼. 원래 `herding_controller_dual/experiments/real_map_sim.py`
...
RESOLUTION_M = 0.05
ORIGIN_X_M, ORIGIN_Y_M = -3.19, -9.03
